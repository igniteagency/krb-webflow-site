"use strict";(()=>{var D="[data-lightbox-template], [data-newsletter-lightbox-template]";var N="krb-lightbox-css",G=/\.(jpe?g|png|webp|gif|avif)(\?.*)?$/i;function v(e){let{root:t,imagesSelector:n="img",template:r=$(t),label:i="Image gallery",initialisedKey:a="lightboxInitialised",imageIndexAttribute:m="lightboxIndex",overlayAttribute:c="data-lightbox",bodyOpenClass:s="lightbox-open",triggerImages:g=!0}=e;if(t.dataset[a]==="true")return;let u=B(t,n);if(!u.length)return;let f=u.map((d,h)=>(d.dataset[m]=String(h),g&&(d.setAttribute("tabindex","0"),d.setAttribute("role","button"),d.setAttribute("aria-label",d.alt?`Open image: ${d.alt}`:"Open image")),{img:d,src:K(d),alt:d.alt||"",caption:W(d)}));X();let o=r?r.cloneNode(!0):Y();o instanceof HTMLElement&&(o.removeAttribute("data-lightbox-template"),o.removeAttribute("data-newsletter-lightbox-template"),o.setAttribute(c,""),o.setAttribute("role","dialog"),o.setAttribute("aria-modal","true"),o.setAttribute("aria-label",i),o.setAttribute("aria-hidden","true"),r&&o.style.removeProperty("display"),document.body.appendChild(o),U(o,f,{bodyOpenClass:s,triggerImages:g}),t.dataset[a]="true")}function B(e,t){return Array.from(e.querySelectorAll(t)).filter(n=>n.currentSrc||n.src).filter((n,r,i)=>i.indexOf(n)===r)}function $(e){return e.querySelector(D)}function X(){if(document.getElementById(N))return;let e=document.createElement("style");e.id=N,e.textContent=`
  ...
  `,e}function U(e,t,n){let r=e.querySelector("[data-lightbox-image]")||e.querySelector("img"),i=e.querySelector("[data-lightbox-caption]"),a=Array.from(e.querySelectorAll("[data-lightbox-counter]")),m=Array.from(e.querySelectorAll("[data-lightbox-counter], [data-lightbox-pagination]")),c=e.querySelectorAll("[data-lightbox-close]"),s=e.querySelectorAll("[data-lightbox-prev]"),g=e.querySelectorAll("[data-lightbox-next]"),u=e.querySelector("[data-lightbox-stage]")||r?.parentElement||e;if(!r)return{open:()=>{},close:()=>{}};let f=t.length>1;F([...s,...g,...m],!f);let o=0,d=null,h=0,b=0,x=()=>{let l=t[o];l&&(r.src=l.src,r.alt=l.alt||l.caption||"Image",i&&(i.textContent=l.caption,i.hidden=!l.caption),a.forEach(E=>{E.textContent=`${o+1} / ${t.length}`}))},H=(l=0)=>{o=_(l,t.length),d=document.activeElement,x(),document.body.classList.add(n.bodyOpenClass),e.classList.add("is-open"),e.setAttribute("aria-hidden","false"),(e.querySelector("[data-lightbox-close]")||e.querySelector("button")||e).focus()},y=()=>{e.classList.remove("is-open"),e.setAttribute("aria-hidden","true"),document.body.classList.remove(n.bodyOpenClass),d instanceof HTMLElement&&d.focus()},M=()=>{f&&(o=_(o-1,t.length),x())},S=()=>{f&&(o=_(o+1,t.length),x())};return n.triggerImages&&t.forEach((l,E)=>{l.img.addEventListener("click",p=>{p.preventDefault(),H(E)}),l.img.addEventListener("keydown",p=>{(p.key==="Enter"||p.key===" ")&&(p.preventDefault(),H(E))})}),c.forEach(l=>l.addEventListener("click",y)),s.forEach(l=>l.addEventListener("click",M)),g.forEach(l=>l.addEventListener("click",S)),e.addEventListener("click",l=>{l.target===e&&y()}),u.addEventListener("touchstart",l=>{let E=l.changedTouches[0];h=E.clientX,b=E.clientY},{passive:!0}),u.addEventListener("touchend",l=>{let E=l.changedTouches[0],p=E.clientX-h,P=E.clientY-b;Math.abs(p)>45&&Math.abs(p)>Math.abs(P)&&(p>0?M():S())},{passive:!0}),document.addEventListener("keydown",l=>{e.classList.contains("is-open")&&(l.key==="Escape"&&y(),l.key==="ArrowLeft"&&M(),l.key==="ArrowRight"&&S())}),{open:H,close:y}}function _(e,t){return t?(e%t+t)%t:0}function F(e,t){e.forEach(n=>{n.hidden=t,n.setAttribute("aria-hidden",String(t)),t?n.style.setProperty("display","none","important"):n.style.removeProperty("display")})}function K(e){let t=e.closest("a[href]"),n=t?.getAttribute("href")||"";return G.test(n)?t?.href||"":e.currentSrc||e.src}function W(e){return(e.closest("figure")?.querySelector("figcaption")?.textContent||e.alt||"").trim()}var z=".newsletter_component",L=".newsletter_side-nav_details",j=".newsletter_side-nav_link",Q=".newsletter_period_item[id]",V=".newsletter_period_item > details",I=".newsletter_rich-text.w-richtext",J=".newsletter-content_component",Z=".newsletter-content_toc",C="krb-newsletter-readmore-transition-css",ee="(min-width: 768px)",T=window.matchMedia(ee);function we(){document.querySelectorAll(z).forEach(t=>{let n=ae(t);te(t),ne(t),oe(n),se(t),he(t),ye(t)})}function te(e){let t=e.querySelector(L),n=t?.parentElement,r=t?.querySelector(j);if(!t||!n||!r)return;let i=ie(re(e));if(!i.size)return;let a=t.open,m=Array.from(i.entries()).map(([c,s],g)=>{let u=t.cloneNode(!0),f=u.querySelector("summary p")||u.querySelector("summary"),o=u.querySelector(".newsletter_side-nav_content"),d=o?.querySelector('[class*="spacer"]')?.cloneNode(!0);return u.open=a&&g===0,f&&(f.textContent=c),o&&o.replaceChildren(...s.map(h=>{let b=r.cloneNode(!0);return b.textContent=h.term,b.setAttribute("href",`#${encodeURIComponent(h.id)}`),b}),...d?[d]:[]),u});n.querySelectorAll(L).forEach(c=>c.remove()),n.append(...m)}function ne(e){let n=e.querySelector(L)?.parentElement;if(!n?.parentElement||n.dataset.responsiveSideNavInitialised==="true")return;n.dataset.responsiveSideNavInitialised="true";let r=document.createComment("newsletter side nav mobile placeholder");n.before(r);let i=()=>{if(T.matches){n.isConnected||r.after(n);return}n.remove()};i(),T.addEventListener("change",i)}function re(e){return Array.from(e.querySelectorAll(Q)).filter(t=>!t.closest(L)).map(t=>{let n=t.closest("[data-year]")?.dataset.year||xe(t.id),r=He(t.id)||t.querySelector("summary")?.textContent?.trim();return!n||!r?null:{year:n,term:Me(r),id:t.id}}).filter(t=>!!t)}function ie(e){return e.reduce((t,n)=>{let r=t.get(n.year)||[];return r.some(a=>a.id===n.id)||t.set(n.year,[...r,n].sort(le)),t},new Map)}function le(e,t){return R(e.term)-R(t.term)}function ae(e){return Array.from(e.querySelectorAll(V)).filter(t=>!t.closest(L))}function oe(e){let t=()=>{e.forEach(n=>{n.open=T.matches})};e.forEach(n=>{if(n.dataset.newsletterDetailsInitialised==="true")return;n.dataset.newsletterDetailsInitialised="true",n.querySelector("summary")?.addEventListener("click",i=>{T.matches&&(i.preventDefault(),n.open=!0)})}),t(),T.addEventListener("change",t)}function se(e){let t=A(e);t&&t.dataset.newsletterArticlesInitialised!=="true"&&(ce(),Array.from(t.children).filter(ue).forEach(n=>{if(n.closest(".newsletter_article"))return;let r=de(n);if(!ge(r))return;let i=Ee(r);if(!i)return;let a=document.createElement("div");a.className="newsletter_article",n.before(a),a.appendChild(n);let m=i.cloneNode(!0);m.classList.add("newsletter_article-summary"),a.appendChild(m);let c=document.createElement("div");c.className="newsletter_article-body",c.style.maxHeight="0px",a.appendChild(c),r.forEach(g=>c.appendChild(g));let s=document.createElement("button");s.type="button",s.className="newsletter_article-toggle",s.setAttribute("aria-expanded","false"),s.innerHTML=`
        <span class="more">Read More</span>
        <span class="less">Read Less</span>
        <span class="newsletter_article-toggle-icon" aria-hidden="true"></span>
      `,a.appendChild(s),s.addEventListener("click",()=>{a.classList.contains("is-open")?fe(a,c,s):pe(a,c,s)})}),t.dataset.newsletterArticlesInitialised="true")}function ce(){if(document.getElementById(C))return;let e=document.createElement("style");e.id=C,e.textContent=`
